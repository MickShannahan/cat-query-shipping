...
function _handleRes(payload) {
  logger.log('[handle res]', payload)
  switch (payload.action) {
    case 'fuse_blown':
      Pop.toast(`${payload.data.name} blown, search of ${payload.hits} pages aborted`, 'info')
      modsService.useMod(payload.data.id)
  }
}
