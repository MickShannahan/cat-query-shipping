<template>
  <div class="scrambler">
    <div class="row">
      <div
        class="col-4 glitch-text clip-text"
        :data-text="`${faces[personality[0]]} - ${phrases[personality[1]]}`"
      >
...
@keyframes scramble {
  ...
  94%{text-shadow: 0px 0px 0px $warning;}
  95%{text-shadow: 0px -4px 0px $warning;  }

  96%{text-shadow: 0px 4px 0px $warning;}
  97%{text-shadow: 3px 0px 0px $warning;  }

  98%{text-shadow: 0px 0px 0px $warning; }
  100%{text-shadow: 3px 0px 0px $warning;}
}
</style>
